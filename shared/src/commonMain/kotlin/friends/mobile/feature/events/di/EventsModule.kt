...
import friends.mobile.feature.events.data.usecase.GetWaitingEventsUseCaseImpl
...
val eventsModule = module {
    ...
    factory<GetWaitingEventsUseCase> {
        GetWaitingEventsUseCaseImpl(repository = get())
    }
