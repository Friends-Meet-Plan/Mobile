...
import friends.mobile.feature.calendar.BusyDaysView
...
import friends.mobile.feature.wishplaces.WishPlacesMode
import friends.mobile.feature.wishplaces.WishPlacesSection
...
fun ProfileScreen(
    ...
    val isRefreshing = (state as? ProfileViewState.Content)?.isRefreshing ?: false
        ...
        when (val current = state) {
            ...
            is ProfileViewState.Content -> {
                PullToRefreshBox(
                    ...
                    onRefresh = { viewModel.obtainEvent(ProfileEvent.OnRefreshProfile) },
                    modifier = Modifier.fillMaxSize().padding(innerPadding)
                ) {
                    ProfileContent(
...
private fun ProfileContent(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(
            top = DesignTheme.Spacing.lg,
            bottom = DesignTheme.Spacing.lg
        ),
